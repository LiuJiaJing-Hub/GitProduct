package com.app.video.user.page.home.adapter
...
class VideoCardAdapter {
    ...
    private fun createCover(context: Context, video: VideoItem): LinearLayout {
        return LinearLayout(context).apply {
            orientation = LinearLayout.VERTICAL
    ...
    private fun createTag(context: Context, text: String): TextView {
        return TextView(context).apply {
            ...
            setBackgroundResource(R.drawable.bg_home_video_tag)
